...
case "$DATASET" in
    jarvis)
        ...
        export MATRIX_TASK="lg-angle-matrix"
        # Three seeds.  On 103 targets the seed spread is the dominant source
        # of variation -- the ALIGNN README records match rate from 0.437 to
        # 0.524 across fifteen models on this split -- so a percent change
        # quoted without a spread here would be meaningless.
    ...
    alex)
        ...
        export MATRIX_TASK="lg-angle-matrix-alex"
