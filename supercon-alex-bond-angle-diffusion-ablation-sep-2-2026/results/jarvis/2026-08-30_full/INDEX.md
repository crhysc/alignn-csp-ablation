# Results index — `2026-08-30_full`

Collected 2026-08-31T13:43:51.178715+00:00 from `/scratch/crc00042/alignn_csp`
(`train/` tree). ALIGNN `<unavail` on `<unavailable: [Errno 2] No such file or directory: 'git'>`  **working tree dirty**, AtomBench `<unavail`.

24 runs over 8 arms: A0, A1, A2, A3, A3_nogate, A4, A6, nolg.
